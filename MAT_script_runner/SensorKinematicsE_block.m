...
function [outcome] = SensorKinematicsE_block(TaskTitle, SubjectNumInt, TrialNumInt, manTrimLeft, manTrimRight, plot_mode, stationaryThreshold, kpStat, kpMove)
...
% Load IMU File
data = csvread(strcat('DataGondar/',TaskTitle,'_',SubjectNum,'_', TrialNum,'.csv'), 1,0); % IMU file name will have two '_'
...
%       
    ...
    %csvwrite(strcat('DataGondar/Output/Output_',TaskTitle,'_',SubjectNum,'_', TrialNum,'.csv'),outcome);
